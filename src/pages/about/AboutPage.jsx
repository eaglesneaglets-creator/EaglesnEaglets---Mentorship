...
// Warm, candid mentor photo — mentor working with a laptop, on-brand for the platform
const heroPhoto = 'https://images.unsplash.com/photo-1556157382-97eda2d62296?q=80&w=1600&auto=format&fit=crop';
                ...
                <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
                    ...
                    <FadeIn delay={0.18} direction="left">
                        <div className="relative">
                            <div className="rounded-2xl sm:rounded-3xl overflow-hidden bg-slate-100 shadow-2xl shadow-slate-300/40 aspect-[4/3]">
                                <img
                                    src={heroPhoto}
                                    alt="Mentor guiding a mentee"
